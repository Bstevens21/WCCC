  ...
  <div class="container marketing">
    ...
    <div class="row">
      <div class="col-lg-4">
        ...
        <p><a class="btn btn-outline-secondary" href="#" role="button">Join &raquo;</a></p>
      </div><!-- /.col-lg-4 -->
      <div class="col-lg-4">
        ...
        <h2>Follow Us</h2>
        <p>Follow us on to get the latest news</p>
        <p><a class="btn btn-outline-secondary" href="#" role="button">Follow &raquo;</a></p>
      </div><!-- /.col-lg-4 -->
      <div class="col-lg-4">
